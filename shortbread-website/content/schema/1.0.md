...
| `tunnel`   | boolean | false   | `true` for `tunnel=yes/building_passage` or {{< tag covered yes >}}, `false` otherwise                             |
...
| ----------------- | :------------------ | :--------------------------------------------------------- | :------- | :--- | :------------------ |
| national capital  | `capital`           | `place=city/town/village/hamlet` + {{< tag capital yes >}} | point    | 4+   | depends on place=\* |
| state capital     | `state_capital`     | `place=city/town/village/hamlet` + {{< tag capital 4 >}}   | point    | 4+   | depends on place=\* |
...
| tunnel         | boolean | 11+  | false               | true for `tunnel=yes/building_passage` or {{< tag covered yes >}}, `false` otherwise                             |
