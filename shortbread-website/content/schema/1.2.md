+++
title = "Vector Tile Schema 1.2 DRAFT"
linkTitle = "1.2 DRAFT"
description = "This page describes the layers of the Shortbread vector schema and their contents as of version 1.2"
toc = true
+++
...
| `link`           | boolean | 5+   | false               | true for link roads ({{< tag highway motorway_link trunk_link primary_link secondary_link tertiary_link >}})               |
...
| `service`        | string  | 10+  | field not available | value of {{< tag service >}}                                                                                               |
